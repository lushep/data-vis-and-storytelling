...
st.radio('This is a radio button with the second option preselected.', ['apple', 'orange', 'pear'], index=1)
st.selectbox('This is a select box with the third option preselected.', ['apple', 'orange', 'pear'], index=2)
st.multiselect('This multiselect allows you to select multiple options at once.', ['apple', 'orange', 'pear'])
st.slider('A slider from 0-10 in steps of 2 with 4 as default', min_value=0, max_value=10, value=4, step=2)
